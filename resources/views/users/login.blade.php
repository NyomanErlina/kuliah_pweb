    ...
    <div class="login-form">
      <div class="sign-in-htm">
          ...
          <div class="form-group" style="padding-top: 10px;">
            ...
            <input type="password" id="password" name="password" class="form-control" data-toggle="password" placeholder="Masukkan Password">
          </div>
        ...
        <div class="hr"></div>
        <div class="foot-lnk">
          <b style="color: white"> N.E.L.D STORE </b>
        </div>
      </div>
