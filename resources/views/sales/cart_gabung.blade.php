        ...
        <table border="1" width="100%" id="tableModal">
          ...
          <tbody>
             @foreach($products as $product)
                <tr>
                  <td>
                    <input id="idProduct" type="hidden" name="" value="{{ $product->product_id }}">{{ $product->product_name }}
                  </td>
                  <td>{{ $product->product_price }}</td>
                  <td>{{ $product->product_stock }}</td>
                  <td>
                    <button type="button" class="add-row btn btn-flat btn-warning" value="Select"></button>
                  </td>
                </tr>
              @endforeach
          </tbody>
    ...
    <form action="/sales" method="post" id="catForm">
        ...
        <div class="col-md-6">
           <div class="form-group" style="padding: 25px 40px 25px 25px;">
              ...
              <br>
              <input type="text" id="selectProduct" value="" onkeyup="showModal(event)" onfocus="select()">
              
              </div>
                
              <br>
              <input type="button" class="btn btn-flat btn-warning" value="Open" onclick="modal()">
      ...
      <br>
         <div class="row" style="padding-left: 25px;">
            ...
            <div style="padding-left: 800px;">
                <input type="button" class="btn btn-flat btn-lg-10 btn-success" value="Process Transaction">
            </div>
...
$(document).ready(function(){
    ...
    $(".add-row").click(function(){
      ...
      //var x= y.childNodes[0].childNodes[0];
      console.log(x);
      ...
      <td style='width: 20%;'>\
          Rp. <input type='number' min='0' oninput='myFunction("+id+")' class='discount dis' name='discount["+id+"]' id='discount"+id+"' required  style='width: 50%'>\
      </td>\
      <td>\
